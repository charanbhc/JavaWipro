...
public class LookUpController 
{
	...
	{	
		ResponseEntity<String> res=resttemp.exchange("http://RoyalEnfield/Bikes/info", HttpMethod.GET, null, String.class);
	...
	{	
		ResponseEntity<String> res=resttemp.exchange("http://PizzaHut/pizzas/info", HttpMethod.GET, null, String.class);
