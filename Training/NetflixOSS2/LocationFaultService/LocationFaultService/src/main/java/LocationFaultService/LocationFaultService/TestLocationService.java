 ...
 *  method-->	The HTTP method (GET, POST, PUT, DELETE, etc.).  Here HttpMethod.GET--> The HTTP method used for this request is GET.
 *  requestEntity-->	Represents the HTTP request body and headers. It can be null if not required.  here null--> (Request Entity)
 ...
 *  
 *  exchange() returns a ResponseEntity<String> and .getBody() extracts the actual response content from ResponseEntity<String>.
 */